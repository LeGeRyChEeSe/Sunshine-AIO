  ...
  makers: [
    {
      ...
      config: {
        ...
        // Story 1.4: require admin privileges at install time so the
        // installer can register services / write to Program Files.
        // The launched app may still start as a standard user — see
        // main.js for the on-demand elevation flow.
        requireAdmin: true,
      },
    },
    {
