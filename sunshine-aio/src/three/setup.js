/**
 * Three.js renderer setup for Sunshine AIO (Story 2-1).
 *
 ...
 *   Zustand imports). Story 2-1 only wires the canvas; the solar
 *   system meshes and store subscriptions land in later stories.
 */
